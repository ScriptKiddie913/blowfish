...
import React, { useEffect, useState, useRef, useCallback, MouseEvent, Suspense } from "react";
...
const DataImporter = React.lazy(() => import("@/components/osint/DataImporter").then(module => ({ default: module.DataImporter })));
const SettingsPage = React.lazy(() => import("@/components/osint/SettingsPage").then(module => ({ default: module.SettingsPage })));
const ThreatIntelSearch = React.lazy(() => import("@/components/osint/ThreatIntelSearch").then(module => ({ default: module.ThreatIntelSearch })));
const CVEExplorer = React.lazy(() => import("@/components/osint/CVEExplorer").then(module => ({ default: module.CVEExplorer })));
const LiveThreatFeed = React.lazy(() => import("@/components/osint/LiveThreatFeed").then(module => ({ default: module.LiveThreatFeed })));
const LiveThreatMap = React.lazy(() => import("@/components/osint/LiveThreatMap").then(module => ({ default: module.LiveThreatMap })));
const UsernameEnumeration = React.lazy(() => import("@/components/osint/UsernameEnumeration").then(module => ({ default: module.UsernameEnumeration })));
const DarkWebScanner = React.lazy(() => import("@/components/osint/DarkWebScanner").then(module => ({ default: module.DarkWebScanner })));
const GraphVisualization = React.lazy(() => import("@/components/osint/GraphVisualization").then(module => ({ default: module.GraphVisualization })));
const NewsIntelligence = React.lazy(() => import("@/components/osint/NewsIntelligence").then(module => ({ default: module.NewsIntelligence })));
const TelegramIntelligence = React.lazy(() => import("@/components/osint/TelegramIntelligence").then(module => ({ default: module.TelegramIntelligence })));
const MalwarePipeline = React.lazy(() => import("@/components/osint/MalwarePipeline"));
const StealthMoleScanner = React.lazy(() => import("@/components/osint/StealthMoleScanner").then(module => ({ default: module.StealthMoleScanner })));
const MonitoringDashboard = React.lazy(() => import("@/components/osint/MonitoringDashboard").then(module => ({ default: module.MonitoringDashboard })));
const SearchHistoryPage = React.lazy(() => import("@/components/osint/SearchHistoryPage").then(module => ({ default: module.SearchHistoryPage })));
const PanicButton = React.lazy(() => import("@/components/osint/PanicButton").then(module => ({ default: module.PanicButton })));
        ...
        <main className="flex-1 overflow-y-auto relative">
          <Suspense fallback={
            ...
            <Routes>
              ...
              <Route path="/threat-intel" element={<RoleGuard allowedRoles={['soc', 'admin']}><ThreatIntelSearch /></RoleGuard>} />
              <Route path="/cve" element={<RoleGuard allowedRoles={['soc', 'admin']}><CVEExplorer /></RoleGuard>} />
              <Route path="/live-threats" element={<RoleGuard allowedRoles={['soc', 'admin']}><LiveThreatFeed /></RoleGuard>} />
              <Route path="/import" element={<RoleGuard allowedRoles={['soc', 'admin']}><DataImporter /></RoleGuard>} />
              <Route path="/settings" element={<SettingsPage />} />
              
              {/* NEW ROUTES */}
              <Route path="/username" element={<RoleGuard allowedRoles={['soc', 'admin']}><UsernameEnumeration /></RoleGuard>} />
              <Route path="/darkweb" element={<RoleGuard allowedRoles={['soc', 'admin']}><DarkWebScanner /></RoleGuard>} />
              <Route path="/graph" element={<RoleGuard allowedRoles={['soc', 'admin']}><GraphVisualization /></RoleGuard>} />
              <Route path="/news" element={<RoleGuard allowedRoles={['soc', 'admin']}><NewsIntelligence /></RoleGuard>} />
              <Route path="/telegram" element={<RoleGuard allowedRoles={['soc', 'admin']}><TelegramIntelligence /></RoleGuard>} />
              <Route path="/malware-pipeline" element={<RoleGuard allowedRoles={['soc', 'admin']}><MalwarePipeline /></RoleGuard>} />
              <Route path="/stealthmole" element={<RoleGuard allowedRoles={['soc', 'admin']}><StealthMoleScanner /></RoleGuard>} />
              <Route path="/threat-map" element={<RoleGuard allowedRoles={['soc', 'admin']}><LiveThreatMap /></RoleGuard>} />
              <Route path="/monitoring" element={<MonitoringDashboard />} />
              <Route path="/history" element={<SearchHistoryPage />} />
              <Route path="/admin" element={<RoleGuard allowedRoles={['admin']} errorRoleName="Administrators"><AdminPanel /></RoleGuard>} />
